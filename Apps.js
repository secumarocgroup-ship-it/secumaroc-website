    ...
    <div className="bg-white text-gray-900 min-h-screen font-sans">
      ...
      <header className="sticky top-0 z-50 bg-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500"> Livraison Pharmacie de Garde 24/7 </p>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 py-12 grid lg:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <h2 className="text-5xl font-extrabold leading-tight mb-6">
            Livraison Pharmacie <br />
            de Garde <span className="text-green-700">Tanger 24/7</span>
          </h2>
      ...
      >
        <div className="bg-white border border-gray-100 rounded-3xl shadow-sm p-6">
          ...
          <p className="text-gray-500 mb-6">Maintenant, près de vous</p>
          ...
          <div className="flex flex-wrap gap-3 mb-6">
            {[
              ...
              <button
                key={tag}
                className="bg-gray-100 hover:bg-green-100 px-4 py-2 rounded-full text-sm font-semibold"
              >
                {tag}
              </button>
            ))}
          ...
          <div className="space-y-4">
            {pharmacies.map((pharmacy) => (
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-gray-500">{pharmacy.time}</p>
        ...
        <div className="rounded-3xl overflow-hidden shadow-lg border border-gray-100 min-h-[700px] bg-gray-100 relative">
          ...
          <div className="absolute bottom-6 right-6 bg-white rounded-2xl p-5 shadow-xl w-72">
            <h4 className="font-bold text-lg mb-1">Pharmacie Ibn Sina</h4>
            <p className="text-gray-500 text-sm mb-4">Centre-ville</p>

            <button className="w-full bg-green-600 hover:bg-green-700 text-white py-3 rounded-xl font-semibold mb-3">
              Voir sur la carte
            </button>

            <button className="w-full border border-gray-200 py-3 rounded-xl font-semibold">
              Itinéraire
            </button>
          </div>
        </div>
            ...
            {[
              {
                ...
                desc: "Par WhatsApp ou téléphone",
              },
              {
                title: "Nous contactons la pharmacie",
                desc: "Nous vérifions la disponibilité",
              },
              {
                title: "Livraison rapide",
                desc: "À votre porte en moins de 30 minutes",
              },
            ].map((step, i) => (
              <div
                key={step.title}
              ...
              >
                <div className="w-14 h-14 rounded-2xl bg-green-100 flex items-center justify-center text-green-700 text-2xl font-bold mb-6">
                  {i + 1}
                </div>
      ...
      {/* AREAS */}
      <section id="zones" className="max-w-7xl mx-auto px-4 py-20">
        <div className="flex items-center justify-between mb-10">
          <h3 className="text-4xl font-bold">Zones couvertes à Tanger</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-3 gap-10">
          <div>
            <h4 className="text-2xl font-bold mb-4">
              Service de livraison pharmacie 24/7 à Tanger
            </h4>
            <p className="text-gray-700 leading-relaxed">
              SecuMaroc vous aide à trouver rapidement les pharmacies
              de garde ouvertes la nuit, les week-ends et les jours
              fériés.
            </p>
          </div>

          <div>
            <h4 className="text-2xl font-bold mb-4 text-right">
              خدمة توصيل الأدوية وصيدليات الحراسة بطنجة
            </h4>
            <p className="text-gray-700 leading-relaxed text-right">
              نوفر خدمة سريعة للعثور على الصيدليات المفتوحة وتوصيل
              الأدوية إلى منزلك في طنجة.
            </p>
          </div>

          <div>
            <h4 className="text-2xl font-bold mb-4">
              Pharmacy delivery service in Tangier
            </h4>
            <p className="text-gray-700 leading-relaxed">
              Find open pharmacies near you and receive emergency
              medicine delivery quickly anywhere in Tangier.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* FAQ */}
      <section id="faq" className="max-w-5xl mx-auto px-4 py-20">
      ...
      <footer className="bg-green-950 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-4 gap-10">
          <div>
            <h4 className="text-3xl font-bold mb-4">SecuMaroc</h4>
            <p className="text-green-100 leading-relaxed">
              Votre service de livraison et d'assistance pharmacie de
              garde 24/7.
            </p>
          </div>
          ...
          <div>
            <h5 className="font-bold text-lg mb-4">Heures de service</h5>
            <p className="text-green-100 leading-relaxed">
              24h/24 – 7j/7
              <br />
        ...
        <div className="border-t border-green-900 mt-12 pt-8 text-center text-green-200 text-sm px-4">
          SecuMaroc est un service indépendant de livraison et
          d’assistance travaillant avec des pharmacies agréées.
        </div>
      </footer>

      {/* FLOATING BUTTONS */}
      <div className="fixed bottom-6 right-6 flex flex-col gap-4 z-50">
        <button className="bg-green-600 hover:bg-green-700 text-white w-16 h-16 rounded-full shadow-2xl text-sm font-bold">
          WA
        </button>

        <button className="bg-red-500 hover:bg-red-600 text-white w-16 h-16 rounded-full shadow-2xl text-sm font-bold">
          Call
        </button>
      </div>
    </div>
...
export default SecuMarocHomepage;
